...
function renderTheme(themeName: 'light' | 'dark'): void { document.documentElement.dataset.theme = themeName; theme.innerHTML = themeName === 'dark' ? '☀ <span>Claro</span>' : '☾ <span>Escuro</span>'; theme.setAttribute('aria-label', themeName === 'dark' ? 'Ativar tema claro' : 'Ativar tema escuro'); }
